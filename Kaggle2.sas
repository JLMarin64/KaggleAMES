PROC IMPORT OUT= WORK.train 
            DATAFILE= "/home/jglin0/sasuser.v94/train.csv" 
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2; 
RUN;
...
PROC IMPORT OUT= WORK.test
            DATAFILE= "/home/jglin0/sasuser.v94/test.csv" 
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2; 
RUN;
